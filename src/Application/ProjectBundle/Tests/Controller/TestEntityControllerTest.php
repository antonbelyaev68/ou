...
namespace Application\ProjectBundle\Tests\Controller;
...
class TestEntityControllerTest extends WebTestCase
{
    ...
    public function testCompleteScenario()
    {
        ...
        $form = $crawler->selectButton('Create')->form(array(
            'application_projectbundle_testentitytype[field_name]'  => 'Test',
        ...
        $form = $crawler->selectButton('Edit')->form(array(
            'application_projectbundle_testentitytype[field_name]'  => 'Foo',
            // ... other fields to fill
        ));
