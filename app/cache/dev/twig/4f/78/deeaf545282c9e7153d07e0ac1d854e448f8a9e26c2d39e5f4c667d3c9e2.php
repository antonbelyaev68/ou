...
/* SonataAdminBundle:ListField:field_tree_down.html.twig */
class __TwigTemplate_4f78deeaf545282c9e7153d07e0ac1d854e448f8a9e26c2d39e5f4c667d3c9e2 extends Twig_Template
{
    ...
    public function block_field($context, array $blocks = array())
    {
        ...
        // line 5
        echo "        ";
        if (($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object")), "parent"), "children"), (twig_length_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object")), "parent"), "children")) - 1), array(), "array"), "id") != $this->getAttribute((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object")), "id"))) {
            // line 6
            echo "            <a href=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("page_tree_down", array("page_id" => $this->getAttribute((isset($context["object"]) ? $context["object"] : $this->getContext($context, "object")), "id"))), "html", null, true);
            echo "\">
                <img  height=\"30\" width=\"30\" src=\"";
            // line 7
            echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("bundles/sonataadmin/arrow_down.png"), "html", null, true);
            echo "\" alt=\"";
            echo $this->env->getExtension('translator')->getTranslator()->trans("Вниз", array(), "messages");
            echo "\" />
            </a>
        ";
        }
    ...
    {
        return "SonataAdminBundle:ListField:field_tree_down.html.twig";
    }
